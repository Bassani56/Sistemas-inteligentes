...
if __name__ == '__main__':
    ...
    vict_folder = os.path.join("..", r"C:\Users\User\Desktop\Sistemas-Inteligentes\projeto-git\VictSim3\datasets\vict/100v")

    # dataset do ambiente (paredes, posicao das vitimas)
    env_folder = os.path.join("..", r"C:\Users\User\Desktop\Sistemas-Inteligentes\projeto-git\VictSim3\datasets\env\12x12_10v")

    # folder das configuracoes dos agentes
    curr = os.getcwd()
    config_ag_folder = os.path.join(curr, r"C:\Users\User\Desktop\Sistemas-Inteligentes\projeto-git\VictSim3\sma\1exp_1soc\config_ag_1")
